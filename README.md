...
JovanaScript, an object oriented programming language that uses the CSC & JOVS compiler and embeds into the JovanaScript Text Editor. It currently supports ConsoleApps, WinApps and Application Extension (DLL) Creation. JovanaScript was first developed at **5/24/2022**, aiming to create another family language of **C** which compiles into C# code using the JOVS & CSC compilers.
